...
time ./landscape --size 512 --output output/1.map --seed 1 --rivers_number 10 --river_width 3 --roughness 0.2 --height 5 --out_height 0 --algorithm diamond_square && ruby landscape.rb output/1.map output/diamond_square.png
